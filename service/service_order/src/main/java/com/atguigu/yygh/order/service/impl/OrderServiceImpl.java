...
public class OrderServiceImpl extends
    ...
    //根据排班的id和就诊人的id生成订单并保存

    @Override
    public Long saveOrder(String scheduleId, Long patientId) {
        //获取就诊人信息 要远程调用patient微服务    getPatientOrder(id)根据就诊人id获取就诊人信息
        Patient patient = patientFeignClient.getPatientOrder(patientId);

        //获取排班相关信息   要远程调用hosp微服务    .getScheduleOrderVo(id)根据排班id获得获取排班的数据
        ...
        //远程调用hosp微服务  获取医院的签名信息，然后通过接口去医院预约下单 现在service里面做的东西都没有真正改变hosp的信息
        //只有调用了接口 才能在排班可预约数量处-1
        ...
        //请求医院系统接口  把map放进httprequest去，然后转化为json数据 然后去请求相关的路径
